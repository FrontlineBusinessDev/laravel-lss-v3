...
class HoursDiscountController extends BaseController
{
    protected string $model = HoursDiscount::class;
    protected string $view = 'developer/settings/rates/hours-discounts/index';
    protected array $sortable = ['min_hours'];
    protected array $activeColumns = ['id', 'min_hours', 'discount_percentage'];
    protected string $sortBy = 'min_hours';

    protected function storeRules(): array
    {
        return [
            'min_hours' => ['required', 'integer', 'min:0', 'unique:app_settings_hours_discounts,min_hours'],
    ...
    {
        return [
            'min_hours' => ['required', 'integer', 'min:0', Rule::unique('app_settings_hours_discounts', 'min_hours')->ignore($model->id)],
            'discount_percentage' => ['required', 'numeric', 'min:0', 'max:100'],
        ];
    }
