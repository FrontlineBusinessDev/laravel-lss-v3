...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/trainees/{id}/learning-outcomes/apply-to', [TraineesController::class, 'applyLearningOutcomesTo'])->name('trainees.learningOutcomes.applyTo')->middleware('throttle:30,1');
