...
export type DocumentKey = 'resume' | 'endorsementLetter' | 'moa' | 'liabilityWaiver' | 'scannedEvaluation'
...
export type LeaveType = 'Sick Leave' | 'Vacation Leave' | 'School-Related Leave' | 'Bereavement Leave'
...
export type AnnouncementAudience = 'All trainees' | 'Specific batch' | 'Trainees with incomplete documents' | 'Custom group'
...
export type SeminarAdminAlertKey = 'new_registration' | 'feedback_submitted' | 'capacity_reached'
...
export interface AppUser {
  ...
  email: string
  mobileNumber?: string
  role: 'Administrator' | 'Program coordinator' | 'Trainer' | 'Finance' | 'Trainee'
