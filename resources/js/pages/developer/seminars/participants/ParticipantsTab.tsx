...
export function ParticipantsTab({
    ...
    const filtered = useMemo(() => {
        ...
        return participants.filter((p) => {
            ...
            if (
                topicFilter &&
                topicFilter !== 'Seminar topic' &&
                p.seminarTopic !== topicFilter
            )
                return false;
            if (p.registeredAt) {
                if (
                    yearFilter &&
                    yearFilter !== 'Year' &&
                    !p.registeredAt.startsWith(yearFilter)
                )
                    return false;
    ...
    return (
        <>
            <div
                className="mb-3 flex flex-col gap-2 rounded-lg border border-neutral-200 bg-white p-3 sm:flex-row sm:flex-wrap sm:items-center"
                data-cy="participants-tab-div-1"
            >
                <div
                    className="relative w-full flex-1 sm:min-w-[160px]"
                    data-cy="participants-tab-div-2"
                >
                    <Search
                        size={14}
                        className="pointer-events-none absolute top-1/2 left-2.5 -translate-y-1/2 text-neutral-400"
                        data-cy="participants-tab-search-3"
                    />
                    <input
                        type="text"
                        value={query}
                        ...
                        data-cy="participants-tab-input-search-name-or-email"
                    />
                </div>
                <div
                    className="grid w-full grid-cols-2 gap-2 sm:flex sm:w-auto sm:flex-wrap"
                    data-cy="participants-tab-div-5"
                >
                    <Dropdown
                        options={[
                            'Seminar topic',
                            ...seminars.map((s) => s.topic),
                        ]}
                        value={topicFilter}
                        placeholder="Seminar topic"
                        onChange={updateFilter(setTopicFilter, 'Seminar topic')}
                        className="sm:w-56"
                        data-cy="participants-tab-dropdown-seminar-topic"
                    />
                    <Dropdown
                        ...
                        className="sm:w-40"
                        data-cy="participants-tab-dropdown-status"
                    />
                    <Dropdown
                        options={['Year', ...years]}
                        value={yearFilter}
                        ...
                        className="sm:w-28"
                        data-cy="participants-tab-dropdown-year"
                    />
                    <Dropdown
                        ...
                        className="sm:w-32"
                        data-cy="participants-tab-dropdown-month"
                    />
                    <input
                        type="date"
                        value={from}
                        ...
                        title="From date"
                        className="h-9 rounded-md border border-neutral-200 px-2 text-xs text-neutral-600 focus:border-brand-500 focus:ring-2 focus:ring-brand-100 focus:outline-none"
                        data-cy="participants-tab-input-from-date"
                    />
                    <input
                        type="date"
                        value={to}
                        ...
                        title="To date"
                        className="h-9 rounded-md border border-neutral-200 px-2 text-xs text-neutral-600 focus:border-brand-500 focus:ring-2 focus:ring-brand-100 focus:outline-none"
                        data-cy="participants-tab-input-to-date"
                    />
                </div>
                {hasActiveFilters && (
                    <button
                        ...
                        data-cy="participants-tab-button-reset-filters"
                    >
            ...
            <div
                ...
                data-cy="participants-tab-div-14"
            >
                <div
                    className="lss-scrollbar overflow-x-auto"
                    data-cy="participants-tab-div-15"
                >
                    <table
                        className="w-full min-w-[720px] border-collapse text-sm"
                        data-cy="participants-tab-table-16"
                    >
                        <thead data-cy="participants-tab-thead-17">
                            <tr
                                className="bg-neutral-50 text-left text-xs font-medium text-neutral-500"
                                data-cy="participants-tab-tr-18"
                            >
                                <th
                                    className="px-4 py-2.5 font-medium"
                                    data-cy="participants-tab-th-status"
                                >
                                    Status
                                </th>
                                <th
                                    className="px-4 py-2.5 font-medium"
                                    data-cy="participants-tab-th-name"
                                >
                                    Name
                                </th>
                                <th
                                    className="px-4 py-2.5 font-medium"
                                    data-cy="participants-tab-th-seminar-topic"
                                >
                                    Seminar topic
                                </th>
                                <th
                                    className="px-4 py-2.5 font-medium"
                                    data-cy="participants-tab-th-email"
                                >
                                    Email
                                </th>
                                <th
                                    className="px-4 py-2.5"
                                    data-cy="participants-tab-th-23"
                                />
                            </tr>
                        </thead>
                        <tbody data-cy="participants-tab-tbody-24">
                            {paged.map((p) => (
                                <tr
                                    ...
                                    data-cy="participants-tab-tr-set-selected"
                                >
                                    <td
                                        className="px-4 py-2.5"
                                        data-cy="participants-tab-td-26"
                                    >
                                        <span
                                            className={cn(
                                            ...
                                            data-cy="participants-tab-span-27"
                                        >
                                            {p.status}
                                        </span>
                                    </td>
                                    <td
                                        ...
                                        data-cy="participants-tab-td-28"
                                    >
                                        {p.name}
                                    </td>
                                    <td
                                        className="px-4 py-2.5 text-neutral-600"
                                        data-cy="participants-tab-td-29"
                                    >
                                        {p.seminarTopic}
                                    </td>
                                    <td
                                        className="px-4 py-2.5 text-neutral-600"
                                        data-cy="participants-tab-td-30"
                                    >
                                        {p.email}
                                    </td>
                                    <td
                                        className="px-4 py-2.5 text-right"
                                        data-cy="participants-tab-td-31"
                                    >
                                        <RowChevron
                                            size={15}
                                            className="ml-auto text-neutral-400"
                                            data-cy="participants-tab-row-chevron-32"
                                        />
                                    </td>
                                </tr>
                            ))}
                            {paged.length === 0 && (
                                <tr data-cy="participants-tab-tr-33">
                                    <td
                                        colSpan={5}
                                        className="px-4 py-10 text-center text-sm text-neutral-500"
                                        data-cy="participants-tab-td-no-participants-match-your-search-or"
                                    >
                                        No participants match your search or
                                        filters.
                                    </td>
                                </tr>
                            )}
            ...
            <div
                ...
                data-cy="participants-tab-div-35"
            >
                {paged.map((p) => (
                    <button
                        key={p.id}
                        ...
                        data-cy="participants-tab-button-set-selected"
                    >
                        <div
                            className="min-w-0 flex-1"
                            data-cy="participants-tab-div-37"
                        >
                            <div
                                className="mb-1 flex items-center gap-2"
                                data-cy="participants-tab-div-38"
                            >
                                <span
                                    className="truncate text-sm font-semibold text-ink"
                                    data-cy="participants-tab-span-39"
                                >
                                    {p.name}
                                </span>
                                <span
                                    className={cn(
                                        ...
                                        PARTICIPANT_STATUS_STYLE[p.status],
                                    )}
                                    data-cy="participants-tab-span-40"
                                >
                                    {p.status}
                                </span>
                            </div>
                            <p
                                ...
                                data-cy="participants-tab-p-41"
                            >
                                {p.seminarTopic}
                            </p>
                            <p
                                className="truncate text-xs text-neutral-400"
                                data-cy="participants-tab-p-42"
                            >
                                {p.email}
                            </p>
                        </div>
                        <RowChevron
                            ...
                            data-cy="participants-tab-row-chevron-43"
                        />
                    </button>
                ))}
                {paged.length === 0 && (
                    <div
                        className="rounded-lg border border-neutral-200 bg-white p-8 text-center text-sm text-neutral-500"
                        data-cy="participants-tab-div-no-participants-match-your-search-or"
                    >
            ...
            >
                ...
                <div className="flex gap-1.5" data-cy="participants-tab-div-47">
                    <button
                        ...
                        data-cy="participants-tab-button-set-page"
                    >
                        <ChevronLeft
                            size={14}
                            data-cy="participants-tab-chevron-left-49"
                        />
                    </button>
                    <button
                        onClick={() =>
                        ...
                        className="flex h-7 w-7 items-center justify-center rounded-md border border-neutral-200 text-neutral-500 transition-colors hover:bg-neutral-50 active:scale-95 disabled:pointer-events-none disabled:opacity-40"
                        data-cy="participants-tab-button-set-page-2"
                    >
                        <ChevronRight
                            size={14}
                            data-cy="participants-tab-chevron-right-51"
                        />
                    </button>
                </div>
            </div>
            ...
            <ParticipantDetailModal
                ...
                onUpdate={onUpdate}
                data-cy="participants-tab-participant-detail-modal-set-selected"
            />
        </>
    );
}
