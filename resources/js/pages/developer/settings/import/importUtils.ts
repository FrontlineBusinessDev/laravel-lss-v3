...
const ACADEMIC_TEMPLATE =
    'name,abbreviation,description,created_at,updated_at\nInformation and Communication Technologies,ICT,,,\n';
...
export const IMPORT_STEPS: ImportStepConfig[] = [
    ...
    },
    {
        ...
        template:
            'school_name,abbreviation,contact_person,contact_email,address,created_at,updated_at\nBatangas State University - Main,BSU - Main,Mac Mac,macmac@gmail.com,"Batangas, Philippines",,\n',
        templateFileName: 'partner_schools_template.csv',
    },
    {
        key: 'batches',
        title: '3. Batches',
        description: 'Matches industry/program type by name, creating missing ones automatically (inactive). batch_code is reused as-is (must stay below FBS-076 to avoid colliding with new auto-generated batches).',
        endpoint: 'batches',
        template:
            'batch_code,setup,industry,program_type,date_started,projected_end_date,is_open,is_completed,is_dissolved,created_at,updated_at\nFBS-036,f2f,Information and Communication Technologies,College On-the-Job Training,2024-03-21,,0,1,0,,\n',
    ...
    },
    {
        ...
        endpoint: 'trainees',
        template:
            'first_name,last_name,email,batch_code,school_name,program_name,level_name,gender,birthday,birth_place,address,mobile_number,emergency_contact_name,emergency_contact_number,required_hours,f2f_hours_rate,online_hours_rate,discount_percent,is_active,created_at,updated_at\nMark Ryan,Merin,macmerin24@gmail.com,FBS-036,Batangas State University - Main,Bachelor of Science in Information Technology,Fourth Year,male,2000-01-01,SPC,SPC,09491040057,n/a,000000,420,22,10,20,1,,\n',
    ...
    },
    {
        ...
        endpoint: 'tasks',
        template:
            'trainee_email,trainer_email,task_title,description,date,time_goal,time_spent,grade,remarks,is_complete,created_at,updated_at\nmacmerin24@gmail.com,mark.bumagat@frontlinebusiness.com.ph,Test,Test task,2024-03-21,3,3,80,,0,,\n',
        templateFileName: 'tasks_template.csv',
    },
    {
        key: 'behavioral-evaluations',
        title: '5c. Behavioral Evaluations',
        description: 'Run Trainees import first. One row per (trainee, date, question) — only the most recent evaluation per trainee is kept. A missing question is created automatically (inactive).',
        endpoint: 'behavioral-evaluations',
        template:
            'trainee_email,trainer_email,date,question_text,score,remarks,created_at,updated_at\nmacmerin24@gmail.com,mark.bumagat@frontlinebusiness.com.ph,2024-01-09,Reports to work on time and regularly,5,Test lang kay Mark,,\n',
