...
export function BiometricsPrint({
    ...
    const wrapperClass =
        variant === 'print'
            ? 'hidden print:block print-area bg-white p-8 text-ink'
            : 'bg-white p-6 text-ink border border-neutral-200 rounded-lg';
    ...
    return (
        <div className={wrapperClass}>
            ...
            <div className="mb-4 grid grid-cols-2 gap-x-6 gap-y-1.5 text-xs">
                ...
                <div>
                    <span className="font-semibold">Total Training Hours:</span>{' '}
                    {totalHours}h
                </div>
            ...
            <table className="w-full border-collapse text-[11px]">
                <thead>
                    <tr className="border border-ink bg-neutral-100">
                        ...
                        <th className="border border-ink px-2 py-1.5 text-right">
                            Hours
                        </th>
                        <th className="border border-ink px-2 py-1.5 text-left">
                            Remarks
                ...
                <tbody>
                    ...
                    {sorted.length === 0 && (
                        <tr>
                            <td
                                className="border border-ink px-2 py-4 text-center text-neutral-400"
                                colSpan={5}
                            >
                                No records in range.
                            </td>
            ...
            <div className="mt-14 grid grid-cols-2 gap-10 text-xs">
                ...
                <div>
                    <div className="border-t border-ink pt-1.5">
                        Admin Signature over Printed Name
                    </div>
                </div>
            </div>
        </div>
