...
export function ImportCsvModal({
    ...
    function processFile(file: File) {
        ...
        reader.onerror = () =>
            setFormatError('Could not read this file. Please try again.');
    ...
    return (
        <Modal
            open={open}
            onClose={handleClose}
            title="Import biometrics CSV"
            maxWidth={rows ? 720 : 480}
        >
            {!rows && !formatError && (
                <div className="flex flex-col gap-3">
                    ...
                    >
                        ...
                        <p className="text-xs text-neutral-400">
                            Trainee Name and Date columns are required.
                        </p>
                        <input
                            ref={fileInputRef}
                            type="file"
                ...
                <div className="flex flex-col gap-4">
                    <div className="grid grid-cols-3 gap-3">
                        ...
                        <div className="rounded-md border border-success-100 bg-success-50 p-3 text-center">
                            ...
                            <div className="text-success-700 text-[11px]">
                                Valid
                            </div>
                        </div>
                        <div className="rounded-md border border-danger-100 bg-danger-50 p-3 text-center">
                            ...
                            <div className="text-danger-700 text-[11px]">
                                Errors
                            </div>
                        </div>
                    </div>

                    <div className="lss-scrollbar max-h-72 overflow-y-auto rounded-md border border-neutral-200">
                                    ...
                                    >
                                        ...
                                        <td className="px-3 py-2">
                                            {r.errors.length === 0 ? (
                                                ...
                                                <span className="text-danger-700 inline-flex items-start gap-1">
                                                    <AlertCircle
                                                        size={12}
