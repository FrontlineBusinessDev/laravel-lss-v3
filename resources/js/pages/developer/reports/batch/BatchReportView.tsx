...
export default function BatchReportView() {
  ...
  async function handlePrint() {
    const res = await reportService.batchExport(activeFilters.filters, activeFilters.search);
  ...
  return (
    <>
      <div className="mb-2 flex items-center justify-end no-print" data-cy="batch-report-view-div-print">
      ...
      {printBatches && (
        <BatchReportPrint batches={printBatches} generatedAt={printGeneratedAt} dateRangeLabel={dateRangeLabel} data-cy="batch-report-view-batch-report-print" />
      )}
    </>
  );
}
