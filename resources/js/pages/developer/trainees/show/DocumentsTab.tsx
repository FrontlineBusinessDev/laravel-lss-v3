...
export default function DocumentsTab({ trainee }: { trainee: Trainee }) {
    ...
    const submittedCount = trainee.documents.filter(
        (d) => docs[d.key]?.link || docs[d.key]?.fileName,
    ).length;
                            ...
                            {state.mode === 'link' ? (
                                ...
                                >
                                    ...
                                    <input
                                        ...
                                        value={state.link ?? ''}
                                        onChange={(e) =>
                                            setLink(doc.key, e.target.value)
                                        }
