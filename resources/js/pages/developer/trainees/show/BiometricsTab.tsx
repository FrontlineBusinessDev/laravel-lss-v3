...
export default function BiometricsTab({ trainee }: { trainee: Trainee }) {
        ...
        >
            ...
            >
                <div data-cy="biometrics-tab-div-3">
                    ...
                    >
                        Attendance logs for {trainee.name} · view-and-print
                        only. Import and bulk edits happen in Admin {'>'}{' '}
                        Biometrics.
                    </p>
                </div>
                <div
                ...
                >
                    <thead data-cy="biometrics-tab-thead-17">
                        ...
                        >
                            ...
                            <th
                                className="px-3 py-2"
                                data-cy="biometrics-tab-th-time-in"
                            >
                                Time in
                            </th>
                            <th
                                className="px-3 py-2"
                                data-cy="biometrics-tab-th-time-out"
                            >
                                Time out
                            </th>
                            <th
