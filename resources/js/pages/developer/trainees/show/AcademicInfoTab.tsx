...
type FormState = Pick<
    ...
    | 'terminationRemarks'
>;
export default function AcademicInfoTab({ trainee }: { trainee: Trainee }) {
            ...
            {!editing ? (
                ...
                >
                    <SelectField
                        ...
                        data-cy="academic-info-tab-select-field-school"
                    />
                    <SelectField
                        label="Academic program"
                        options={programOptions}
                        value={draft.academicProgram}
                        onChange={(e) => set('academicProgram', e.target.value)}
                        data-cy="academic-info-tab-select-field-academic-program"
                    />
                    <SelectField
                        label="Academic level"
                        ...
                        data-cy="academic-info-tab-select-field-academic-level"
                    />
                    <SelectField
                        label="Program type"
                        ...
                        data-cy="academic-info-tab-select-field-program-type"
                    />
                    <SelectField
                        label="Industry"
                        ...
                        data-cy="academic-info-tab-select-field-industry"
                    />
                    <TextField
                        label="Required hours"
                        type="number"
                        min={0}
                        value={draft.requiredHrs}
                        onChange={(e) =>
                            set('requiredHrs', Number(e.target.value))
                        }
                    ...
                    <TextField
                        ...
                        data-cy="academic-info-tab-text-field-date-started"
                    />
                    <TextField
                        label="Date completed"
                        type="date"
                    ...
                    >
                        <TextAreaField
                            ...
                            onChange={(e) =>
                                set('terminationRemarks', e.target.value)
                            }
