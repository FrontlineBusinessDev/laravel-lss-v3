import { ApiError } from '@/api-service-layer';
import { behavioralQuestionsService } from '@/api-service-layer/admin/behavioral-ratings';
import { BehavioralQuestion } from '@/types/modules/ratings/behavioral';
...
export function index() {
    ...
    const filtered = questions
        .filter((q) =>
            filter === 'all'
                ? true
                : q.status === (filter === 'archived' ? 'inactive' : 'active'),
        )
