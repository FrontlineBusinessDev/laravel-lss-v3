                            ...
                            <tbody>
                                {batchTrainees.map((tr) => {
                                    ...
                                    const avg = existing
                                        ...
                                        : 0;
                                    return (
                                        <tr key={traineeId} className="border-t border-neutral-100 align-top">
                                            <td className="px-4 py-3">
                                                <div className="font-medium text-ink">
                                                    {traineeName(tr)}
                                                </div>
                                                <div className="text-xs text-neutral-400">
                                                    {tr.school?.school_name ?? '—'}
                                                </div>
                                            </td>
                                            <td className="px-4 py-3">
                                                {existing ? (
                                                ...
                                                <div className="flex flex-wrap items-center justify-end gap-1.5">
                                                    ...
                                                    {existing && (
                                                        <Button
                                                            ...
                                                            icon={Printer}
                                                            onClick={() =>
                                                                printEvaluation(traineeId, traineeName(tr))
                                                            }
                                                        >
                                                            Print
                                                        </Button>
                        ...
                        <div className="mb-5 flex flex-col gap-5">
                            ...
                            {questions.length === 0 && (
                                <div className="rounded-md border border-dashed border-neutral-200 p-6 text-center text-sm text-neutral-500">
                                    ...
                                    the Behavioral Setup tab first.
                                </div>
                            )}
