            ...
            >
                ...
                <div data-cy="access-override-panel-div-4">
                    ...
                    >
                        ...
                        from the evaluation form. Grant an override below to let
                        a specific trainee proceed anyway.
                    </p>
                </div>
            </div>
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    />
                                    {t.batchNo} &middot; missing{' '}
                                    {t.missingDocuments?.length ?? 0} document
                                    {(t.missingDocuments?.length ?? 0) === 1
                                        ? ''
                                        : 's'}
                                </p>
                            </div>
