...
export function TrainersQuestionnaireTab({
  ...
  return <div className="flex flex-col gap-4" data-cy="trainers-questionnaire-tab-div-1">
      <QuestionsPanel category="Trainer" questions={questions} onChange={onChange} currentUserName={currentUserName} sets={sets} onAddSet={onAddSet} data-cy="trainers-questionnaire-tab-questions-panel-change" />
