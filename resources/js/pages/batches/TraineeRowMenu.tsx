...
export function TraineeRowMenu({
  trainee,
  onView,
  onTransfer,
  onTerminate,
  ...
  return <RowMenu actions={[{
    ...
    label: 'Transfer trainee',
    icon: ArrowLeftRight,
    onClick: onTransfer,
    disabled: isArchived
  }, isArchived ? {
    label: 'Restore trainee',
    icon: ArchiveRestore,
    onClick: onRestore
  } : {
    label: 'Archive trainee',
    icon: Archive,
    onClick: onArchive
  }, {
    label: 'Terminate trainee',
    icon: UserX,
    onClick: onTerminate,
    danger: true,
    disabled: isTerminated || isArchived
  }]} data-cy="trainee-row-menu-row-menu-1" />;
}