...
export default function ReportsPrimaryLayout({ children }: LayoutProps) {
    const { url } = usePage();
    return (
        <div data-cy="reports-primary-layout-div-1">
            <div className="mb-4 no-print" data-cy="reports-primary-layout-div-2">
                <h1
            ...
            <div
                className="mb-4 flex gap-5 border-b border-neutral-200 pl-0.5 no-print"
