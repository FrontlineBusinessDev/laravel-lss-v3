...
export const columns: ColumnDef<PartnerSchools>[] = [{
  ...
  // the raw path text.
  render: value => <Thumbnail src={value as string} alt="School logo" className="h-10 w-10 rounded-lg border border-slate-200 object-cover" data-cy="partner-schools-thumbnail-1" />
}, {
