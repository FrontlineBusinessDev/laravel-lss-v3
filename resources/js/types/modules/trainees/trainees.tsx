...
export const columns: ColumnDef<AppTrainees>[] = [{
  ...
  key: 'date_completed',
  label: 'Status',
  render: value => value ? <span className="font-medium text-green-600" data-cy="trainees-span-completed">
                    Completed ({value as string})
                </span> : <span className="font-medium text-amber-500" data-cy="trainees-span-on-going">On-going</span>
}];
