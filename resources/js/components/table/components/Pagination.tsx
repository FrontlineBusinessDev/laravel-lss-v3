...
export function PageBtn({
    ...
    return (
        <button
            ...
            data-cy="pagination-button-title"
        >
            {children}
        </button>
    );
            ...
            {pages.map((p, i) =>
                p === '…' ? (
                    ...
                    <PageBtn
                        ...
                        data-cy="pagination-page-btn-change"
                    >
                        {p}
                    </PageBtn>
                ),
    ...
    return (
        ...
        >
            ...
            <div
                ...
                data-cy="pagination-div-6"
            >
                <PageBtn
                    disabled={page <= 1 || loading}
                    onClick={() => onPageChange(1)}
                    title="First page"
                    data-cy="pagination-page-btn-first-page"
                >
                    <ChevronsLeft
                        className="size-3"
                        data-cy="pagination-chevrons-left-8"
                    />
                </PageBtn>
                <PageBtn
                    disabled={page <= 1 || loading}
                    ...
                    title="Previous page"
                    data-cy="pagination-page-btn-previous-page"
                >
                    <ChevronLeft
                        className="size-3"
                        data-cy="pagination-chevron-left-10"
                    />
                </PageBtn>
                <PageNumbers
                    current={page}
                    ...
                    data-cy="pagination-page-numbers-page-change"
                />
                <PageBtn
                    disabled={page >= meta.last_page || loading}
                    onClick={() => onPageChange(page + 1)}
                    title="Next page"
                    data-cy="pagination-page-btn-next-page"
                >
                    <ChevronRight
                        className="size-3"
                        data-cy="pagination-chevron-right-13"
                    />
                </PageBtn>
                <PageBtn
                    disabled={page >= meta.last_page || loading}
                    ...
                    title="Last page"
                    data-cy="pagination-page-btn-last-page"
                >
                    <ChevronsRight
                        className="size-3"
                        data-cy="pagination-chevrons-right-15"
                    />
                </PageBtn>
            </div>
        </div>
