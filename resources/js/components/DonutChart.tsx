...
export function DonutChart({
    ...
    return (
        <div
            ...
            data-cy="donut-chart-div-1"
        >
            <svg
                viewBox="0 0 100 100"
                className="h-28 w-28 shrink-0 -rotate-90"
                data-cy="donut-chart-svg-2"
            >
                <circle
                    cx="50"
                    cy="50"
            ...
            <div className="min-w-50 flex-1" data-cy="donut-chart-div-5">
                <div
                    className="text-2xl font-semibold text-ink"
                    data-cy="donut-chart-div-6"
                >
                    {centerValue}
                </div>
                <div
                    className="mb-2 text-xs text-neutral-500"
                    data-cy="donut-chart-div-7"
                >
                    {centerLabel}
                </div>
