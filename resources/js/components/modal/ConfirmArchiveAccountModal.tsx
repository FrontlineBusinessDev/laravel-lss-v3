            ...
            >
                {isSelfSuspend ? (
                    <h2 className="text-lg font-semibold">
                        ...
                        <span className="mt-1 block text-sm font-normal text-primary">
                ...
                <p className="mt-1.5 text-sm dark:text-slate-300">
                ...
                <div className="mt-6 flex items-center justify-end gap-2">
                    <button
                        ...
                        onClick={onCancel}
                        disabled={busy}
                        className="rounded-xl border border-slate-200 px-4 py-2.5 text-sm font-medium hover:bg-slate-100/90 hover:dark:bg-slate-100/20"
                    >
                        Cancel
                    </button>
                    <button
