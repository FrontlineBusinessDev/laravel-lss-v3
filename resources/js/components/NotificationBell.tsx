    ...
    return (
        <>
            <button
                ...
                data-cy="notification-bell-button-button"
            >
                <Bell size={17} data-cy="notification-bell-bell-2" />
                {unreadCount > 0 && (
                    <span
                        className="absolute -top-0.5 -right-0.5 flex h-4 min-w-[16px] items-center justify-center rounded-full bg-danger-600 px-1 text-[9px] leading-none font-bold text-white"
                        data-cy="notification-bell-span-3"
                    >
            ...
            {open &&
                createPortal(
                    <div
                        ...
                        data-cy="notification-bell-div-4"
                    >
                        <div
                            className="flex items-center justify-between border-b border-neutral-100 px-3.5 py-2.5"
                            data-cy="notification-bell-div-5"
                        >
                            <span
                                className="text-sm font-semibold text-ink"
                                data-cy="notification-bell-span-notifications"
                            >
                                Notifications
                            </span>
                            {unreadCount > 0 && (
                                <button
                                    ...
                                    data-cy="notification-bell-button-mark-all-read"
                                >
                                    <CheckCheck
                                        size={12}
                                        data-cy="notification-bell-check-check-8"
                                    />{' '}
                                    Mark all read
                                </button>
                            )}
                        ...
                        <div
                            className="lss-scrollbar max-h-[54vh] overflow-y-auto"
                            data-cy="notification-bell-div-9"
                        >
                            {notifications.length === 0 && (
                                <div
                                    className="px-4 py-8 text-center text-xs text-neutral-400"
                                    data-cy="notification-bell-div-no-notifications-yet"
                                >
                                    <CalendarOff
                                        size={18}
                                        className="mx-auto mb-2 text-neutral-300"
                                        data-cy="notification-bell-calendar-off-11"
                                    />
                            ...
                            {notifications.map((n) => (
                                <button
                                    ...
                                    data-cy="notification-bell-button-open-notification"
                                >
                                    <span
                                        className={cn(
                                        ...
                                        data-cy="notification-bell-span-13"
                                    />
                                    <span
                                        className="min-w-0 flex-1"
                                        data-cy="notification-bell-span-14"
                                    >
                                        <span
                                            className={cn(
