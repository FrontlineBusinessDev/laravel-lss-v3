...
export function ErrorFallback({
    ...
    return (
        <div className="flex h-[60vh] w-full flex-col items-center justify-center p-4 text-center">
            ...
            <Link
                href={backToHref}
                className="mt-6 inline-flex items-center justify-center rounded-md bg-brand-500 px-4 py-2 text-sm font-medium text-white shadow-sm transition-colors hover:bg-brand-600"
            >
                {backToLabel}
            </Link>
        </div>
