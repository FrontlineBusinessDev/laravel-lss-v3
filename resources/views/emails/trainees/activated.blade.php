...
@section('content')
            <div style="font-family:'Plus Jakarta Sans',Arial,sans-serif; font-size:11.5px; font-weight:700; letter-spacing:.1em; text-transform:uppercase; color:#378add; margin-bottom:12px;">Application approved</div>
            ...
            <p style="font-family:'Plus Jakarta Sans',Arial,sans-serif; font-size:14.5px; line-height:1.6; color:#4b5159; margin:0 0 22px;">Your application has been approved and your account is ready. Set up your password below to log in and get started.</p>
            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border:1px solid #ecedf1; border-radius:12px; margin-bottom:24px;">
              <tr>
                <td style="padding:12px 16px; font-family:'Plus Jakarta Sans',Arial,sans-serif; font-size:13px; color:#9099a3; font-weight:500;">Account email</td>
                <td align="right" style="padding:12px 16px; font-family:'Plus Jakarta Sans',Arial,sans-serif; font-size:13px; color:#14151a; font-weight:600;">{{ $user->email }}</td>
              </tr>
            </table>
